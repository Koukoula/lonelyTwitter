...
public class IntentReaderActivityTest extends ActivityInstrumentationTestCase2{
    ...
    public void testSendText(){
        ...
        assertEquals("IntentReaderActivty should get the text from intent",
                "message 1", ira.getText());
    }
    public void testDeisplayText(){
        Intent intent = new Intent();
...
//-------------------------------------------------------------------------------
    public void testReverseText(){
        ...
        setActivityIntent(intent);
        IntentReaderActivity ira =(IntentReaderActivity) getActivity();
        assertEquals("The text should be reveresed", "4 egassem",
                ira.getText());
    }
    ...
    public void testDefaultText(){
        ...
        setActivityIntent(intent);
        IntentReaderActivity ira =(IntentReaderActivity) getActivity();
        assertEquals("The text should be default", "default text",
                ira.getText());    }
